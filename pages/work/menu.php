<nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
	...
	<li class="nav-item">
      <a class="nav-link" href="/wclientlist">Список клиентов</a>
    </li>	
	<li class="nav-item">
      <a class="nav-link" href="/worderlist">Список заказов</a>
    </li>	
...
<li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="/wreportclient">Все клиенты</a>
        <a class="dropdown-item" href="/wreportorder">Все заказы</a>
      </div>
    </li>
